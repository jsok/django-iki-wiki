...
DATABASE_PATH = os.path.join(os.path.join(PROJECT_ROOT, 'db'), DATABASE_NAME)
...
# http://en.wikipedia.org/core/List_of_tz_zones_by_name
...
SECRET_KEY = '*kv41@dym4f!rwks426+id)+gx^%@z0i(5^qujv8_8=@f*y7o+'
